  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>FM Daily Shop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               FM Daily Shop Head Office
               Email:support@fmdailyshop.com <br>
...
<h3>Products</h3>
    ...
    <table width="100%">
        ...
        <tbody>
            ...
            <tr class="font">
                <td align="center">
                    <img src="{{ public_path('storage/products/thambnail/'.$item->product->product_thambnail)  }}" height="60px;" width="60px;" alt="">
                </td>
