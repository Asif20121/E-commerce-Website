...
<div class="content_one" id="login_content_one" >
    <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel" style="text-align: center; padding-top: 20px; width: 100%; font-size: 50px; color: coral;">Login</h5>
    </div>
    <div class="modal-body">
        <div class="conttent">
            ...
            <div id="mobile_login_sec">
                <p style="text-align: center;">PLEASE ENTER YOUR MOBILE PHONE NUMBER</p>
                <input class="modal_input" type="phone" value="+880">
