...
<div class="container">
    <div style="display: flex;"> <a href="{{ url('/')}}" style="text-decoration: none;">@if (session()->get('language')=='bangla')
       ...
       <h1>Home</h1> 
        @endif </a> <h1> /</h1>
        <a href="{{ route('productPage.category', [ 'mainCategory_id'=>$sub_category->category->id, 'mainCategory_name'=>$sub_category->category->category_name_en] )}}" style="text-decoration: none;">  <h1> {{ session()->get('language')=='bangla'?$sub_category->category->category_name_bn : $sub_category->category->category_name_en }} </h1> </a>
        <h1>/ {{ session()->get('language')=='bangla'?$sub_category->subcategory_name_bn : $sub_category->subcategory_name_en }} </h1> 
    </div> 
